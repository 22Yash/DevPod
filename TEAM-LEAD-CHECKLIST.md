...
- [ ] TEAM-SETUP-GUIDE.md is in root directory
- [ ] CODESERVER-LOGIN-FIX.md is in root directory
- [ ] ENV-SETUP-TEMPLATE.md is in root directory
- [ ] QUICK-REFERENCE.md is in root directory
- [ ] SETUP-DOCUMENTS-SUMMARY.md is in root directory
- [ ] QUICK-SETUP.bat is in root directory (Windows)
- [ ] QUICK-SETUP.sh is in root directory (macOS/Linux)
...
- [ ] GitHub OAuth App created
  - [ ] Client ID noted
  - [ ] Client Secret noted
  - [ ] Callback URL set to `http://localhost:3000/auth/callback`
...
**Solution:**
- Run build script: `build-images.bat` or `./build-images.sh`

...
3. Run: `scripts/build/build-images-manual.bat`
...
### Build Scripts
- **scripts/build/build-images-manual.bat** - Automatic build (Windows CMD)
- **scripts/build/build-images-manual.ps1** - Automatic build (PowerShell)
...
**Files:**
- `scripts/build/build-images-manual.bat` (run this)
...
3. Run: `scripts/build/build-images-manual.bat` (15-30 min)
...
```
Windows Build Files:
├── scripts/build/build-images-manual.bat          ← Run this (automatic)
├── scripts/build/build-images-manual.ps1          ← Or this (PowerShell)
...
2. Run `scripts/build/build-images-manual.bat`
...
3. Navigate to project
   ↓
4. Run scripts/build/build-images-manual.bat
   ↓
...
**Start here:** `WINDOWS-QUICK-BUILD.txt` or run `scripts/build/build-images-manual.bat`

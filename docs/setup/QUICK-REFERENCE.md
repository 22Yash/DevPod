...
- [ ] Docker images built (`scripts\\build\\build-images.bat` or `./scripts/build/build-images.sh`)
...
- FRONTEND_URL in backend/.env is `http://localhost:5173`
...
| Frontend | http://localhost:5173 | React app (docker) |

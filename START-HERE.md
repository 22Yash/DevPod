...
| **QUICK-SETUP.bat** | Windows automation | 10-15 min |
| **QUICK-SETUP.sh** | macOS/Linux automation | 10-15 min |
...
- [ ] Repository cloned
- [ ] Setup script run (QUICK-SETUP.bat or QUICK-SETUP.sh)
...
→ **TEAM-SETUP-GUIDE.md** or **QUICK-SETUP.bat/sh**
...
├── QUICK-SETUP.sh               ← macOS/Linux automation

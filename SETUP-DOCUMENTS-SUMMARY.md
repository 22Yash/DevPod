...
### 5. **QUICK-SETUP.bat** ⚡ WINDOWS AUTOMATION
...
### 6. **QUICK-SETUP.sh** ⚡ MACOS/LINUX AUTOMATION
...
2. Or use: **QUICK-SETUP.bat** (Windows) or **QUICK-SETUP.sh** (macOS/Linux)
...
| QUICK-SETUP.bat | Automation | Windows | 10-15 min | Low |
| QUICK-SETUP.sh | Automation | macOS/Linux | 10-15 min | Low |
...
├─ Rebuild: build-images.bat (Windows) or ./build-images.sh
...
1. **Choose your setup method:**
   - Automated: Use QUICK-SETUP.bat (Windows) or QUICK-SETUP.sh (macOS/Linux)

...
2. **QUICK-SETUP.bat** (Windows) or **QUICK-SETUP.sh** (macOS/Linux)
...
```
1. This file (README-SETUP.md) - 2 min
2. QUICK-SETUP.bat or QUICK-SETUP.sh - 10-15 min
3. ENV-SETUP-TEMPLATE.md - 10-15 min
...
1. **Choose your setup method:**
   - Automated: QUICK-SETUP.bat (Windows) or QUICK-SETUP.sh (macOS/Linux)
...
| QUICK-SETUP.bat | Automation (Windows) | 10-15 min | Windows users |
| QUICK-SETUP.sh | Automation (macOS/Linux) | 10-15 min | macOS/Linux users |

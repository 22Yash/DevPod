...
| Task | Command |
|------|---------|
| Build all remaining | `build-images-manual.bat` |
...
- **build-images-manual.bat** - Automatic build script (Windows CMD)
- **build-images-manual.ps1** - Automatic build script (PowerShell)
